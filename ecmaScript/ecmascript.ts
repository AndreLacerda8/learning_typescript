...
const cpf: string = '123.456.00-00'
// cpf = '190.182.292-10'
console.log(cpf)
...
const turmaA: string[] = ['Joao', 'Maria', 'Gabriel']
const turmaB: string[] = ['Fernando', 'Miguel', ...turmaA]
console.log(turmaB)

function retornarAray(...args: number[]): number[] {
    return args
}
...
//Template string
const user: string = 'Fulano'
const notifications: number = 8
